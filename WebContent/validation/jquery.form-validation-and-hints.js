...
function isTypeValid( type, value ) {
	...
	if( type == classprefix + 'Cim' ) {
		return ( value.match( /^(40|41|99|98|97|96|95|94|93|92)[0-9]{6}$/)  );
	}
	if( type == classprefix + 'Cin' ) {
	...
	if( type == classprefix + 'Mail' ) {
		...
		var emailFilter=/^[_a-zA-Z0-9\\-]+(\.[_a-zA-Z0-9\\-]+)*@[a-zA-Z0-9\\-]+(\.[a-zA-Z0-9\\-]+)*(\.[a-z]{2,3})$/;
		var illegalChars= /[\(\)\<\>\,\;\:\\\/\"\[\]]/	;	
