...
this.aanFeatures=[];this.oLanguage={sProcessing:"Processing...",sLengthMenu:"Voir _MENU_ entrées",sZeroRecords:"Aucun enregistrement correspondant n'a été trouvé",sEmptyTable:"Pas de données disponibles dans le tableau",sInfo:"Affichage de _START_ à _END_ de  _TOTAL_ entrées",sInfoEmpty:"Affichage de 0 à 0 de 0 entrées",sInfoFiltered:"(filtrées à partir de _MAX_ entrées)",sInfoPostFix:"",sSearch:"Chercher :",sUrl:"",oPaginate:{sFirst:"Première",sPrevious:"précédent",sNext:"Suivant",sLast:"Dernière"},fnInfoCallback:null};this.aoData=[];this.aiDisplay=[];this.aiDisplayMaster=
