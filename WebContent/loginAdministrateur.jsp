...
<body>
	<div id="main">
		<div id="menubar">
			<ul id="menu">
			<li class="current"><a href="loginAdministrateur.jsp">Espace Administrateur</a></li>
				<li ><a href="loginEtudiant.jsp">Espace
	...
	<center>
		<fieldset id="myFieldset">
			<form method="post" action="/enit/LoginAdmin" class="login">
				...
				<center>
					<img id="imgcadna" src="images/cadna.jpg" />
				</center>
			</form>
 <br /> <br />
		</fieldset>
